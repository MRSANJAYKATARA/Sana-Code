# Sana Code Privacy Policy

**Effective date:** September 7, 2026
**Developer:** Sanjay Katara (SanjayXLegacy)
**YouTube:** https://youtube.com/@sanjayxlegacy?si=WdwPmoIqYRZhQ-cV

Sana Code is an autonomous local-first Android development workspace. This policy explains what information the app handles, where it is stored, and when information leaves the device.

## Information handled by the app

Sana Code may handle the following information when you choose to provide it:
...
Sana Code does not currently include advertising or analytics SDKs and does not operate a first-party user account system.
...
Sana Code does not sell personal information. It does not send projects or conversations to the Sana Code developer unless you explicitly share them, submit diagnostics, or use a future opt-in backup or support feature.
...
Local information remains on the device until you delete the relevant project, clear it from the app, or uninstall Sana Code. Uninstalling the app removes its private local data according to Android's behavior.
...
Sana Code uses app-private Android storage, Android Keystore-backed credential encryption, HTTPS for external services, and checksum verification for supported runtime downloads. No system can guarantee complete security. Code executed inside the local Linux environment should be limited to projects and dependencies you trust.

## Children

Sana Code is a developer tool and is not directed to children under 13. The app does not knowingly collect personal information from children.

## Changes to this policy

This policy may be updated as Sana Code changes. Material changes will be reflected by updating the effective date and publishing the revised policy at the official repository.

## Contact & Support

For questions, support, or requests:
- **Developer:** Sanjay Katara
- **Brand:** SanjayXLegacy
- **Official Channel:** [https://youtube.com/@sanjayxlegacy](https://youtube.com/@sanjayxlegacy?si=WdwPmoIqYRZhQ-cV)
