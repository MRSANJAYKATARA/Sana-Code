...
val privacyPolicyUrl = providers.gradleProperty("privacyPolicyUrl").orNull
    ?: "https://github.com/MRSANJAYKATARA/Sana-Code/blob/main/PRIVACY.md"
...
android {
    ...
    defaultConfig {
        applicationId = "com.sanjayxlegacy.sanacode"
        minSdk = 28
        ...
        buildConfigField("String", "DEVELOPER_NAME", buildConfigString("Sanjay Katara"))
        buildConfigField("String", "POWERED_BY", buildConfigString("SanjayXLegacy"))
        buildConfigField("String", "YOUTUBE_URL", buildConfigString("https://youtube.com/@sanjayxlegacy?si=WdwPmoIqYRZhQ-cV"))
